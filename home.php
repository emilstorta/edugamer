...
<!-- De forskellgie fag. OBS. Det er kun Kristendom der er et fungerende link -->    
    <h1 class="overskrift">Dine fag</h1>
        <section class="workSpace">
            <article class="homeCell">
                <article class="smallhomeCell">
                    <article class="innerCell">
                        <img src="pictures/historie trans.png" alt="Historie" class="imgSize">
                    </article>
        ...
        <article class="homeCell2">
            <article class="smallhomeCell">
                <article class="innerCell">
                    <img src="pictures/english.png" alt="Engelsk" class="imgSize">
                </article>
                <article class="innerCell2">
                    <h2>Engelsk</h2>
                </article>
        ...
        <article class="homeCell3">
            <article class="smallhomeCell">
                <article class="innerCell">
                    <img src="pictures/math.png" alt="Matematik" class="imgSize">
                </article>
                <article class="innerCell2">
                    <h2>Matematik</h2>
                </article>
        ...
        <a href="kristendom.php">
            <artcile class="homeCell4">
                <article class="smallhomeCell">
                    <article class="innerCell">
                        <img src="pictures/handsthick.png" alt="Kristendomskunstskab" class="imgSize">
                    </article>
                    <article class="innerCell2">
        ...
        <article class="homeCell5">
            <article class="smallhomeCell">
                <article class="innerCell">
                    <img src="pictures/tree.png" alt="Naturfag" class="imgSize">
                </article>
                <article class="innerCell2">
                    <h2>Naturfag</h2>
                </article>
        ...
        <article class="homeCell6">
            <article class="smallhomeCell">
                <article class="innerCell">
                    <img src="pictures/samfund.png" alt="Samfundsfag" class="imgSize">
                </article>
                <article class="innerCell2">
                    <h2>Samfundsfag</h2>
                </article>
