...
<body>
    ...
    <section class="textWorkSpace marginTop">
        ...
        <p class="formText">
        De fleste kristne, muslimer, hinduer, buddhister og jøder tror ikke, fordi de ikke forstår de grundlæggende naturlove. De tror på trods af denne virkelighedssans. Når du tror på opsvinget midt i finanskrisen, giver det håb. Når du traumatiseres af krigens rædsler, men vælger stadig at tro på det gode i mennesket, skaber det tillid. Når vi skaber teknologier, koalitioner og stor kunst, får fantasien frit løb. 
        ...
        <article class="textCell4"><h2>Opgave 3 <br><br>Drag and drop</h2><br><p>Træk de sætninger, som du synes besvarer spørgsmålene, ned i det nedenstående bokse.
            ...
            <form method="GET" class="formClass">
                    ...
                    <p class="formText">Hvorfor mener teksten blandt andet, at mennesker vælger at være troende?</p>
                        <div id="drag_target2" ref="drag_target" class="drag-target" @drop="drop_handler2" @dragover="dragover_handler"></div>
            </form>
